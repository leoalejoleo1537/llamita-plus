...
| **Lama · arqueo de caja** | **100 %** | 5 de 5 | 🟢 fecha/hora y borrar **vivos** (SQL corrido el 2026-09-23) |
...
**✅ Los dos `.sql` (horario y borrar) los corrió Jhon el 2026-09-23**, sanos: 1 firma en cada función.
Prueba: 47 casos.
