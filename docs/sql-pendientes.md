...
**✅ Nada pendiente al 2026-09-23.** Los dos del arqueo se corrieron hoy y
están abajo, en el historial.
...
### [x] `sql/2026-09-lama-arqueo-horario.sql` — **corrido el 2026-09-23** ✅

> **La fecha y hora de apertura, confirmada sana:** "1 firma" en
> `arqueo_abrir` y en `arqueo_cerrar`, y "0" arqueos sin hora real. Desde
> ahora se puede abrir una caja con la hora hacia atrás, se guarda la hora
> real aparte, y una venta ya contada en un arqueo cerrado no se cuenta en
> el siguiente. El SQL sigue en `sql/`.

### [x] `sql/2026-09-lama-arqueo-eliminar.sql` — **corrido el 2026-09-23** ✅

> **Borrar arqueo, confirmado sano:** "1 firma" en `arqueo_eliminar` y "sí"
> en que el estado `eliminada` se acepta. Un arqueo borrado queda gris y
> tachado en la lista, con quién y cuándo. El SQL sigue en `sql/`.
